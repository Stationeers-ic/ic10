...
describe("select", () => {
	...
	test.todo("sap", () => {
		expect(runFunc(functions.sap, ["r0", "r0", "r0", "r0"], { r0: 1 })).resolves.toBe(1)
		expect(runFunc(functions.sap, ["r0", "r0", "r0", "r0"], { r0: 0 })).resolves.toBe(0)
		expect(runFunc(functions.sap, ["r0", "r0", "r0", "r0"], { r0: -1 })).resolves.toBe(0)
	})
	test.todo("sapz", () => {
	...
	test.todo("sna", () => {
		expect(runFunc(functions.sna, ["r0", "r0", "r0", "r0"], { r0: 1 })).resolves.toBe(0)
		expect(runFunc(functions.sna, ["r0", "r0", "r0", "r0"], { r0: 0 })).resolves.toBe(1)
		expect(runFunc(functions.sna, ["r0", "r0", "r0", "r0"], { r0: -1 })).resolves.toBe(1)
	})
	test.todo("snaz", () => {
		expect(runFunc(functions.snaz, ["r0", "r0", "r0"], { r0: 1 })).resolves.toBe(0)
		expect(runFunc(functions.snaz, ["r0", "r0", "r0"], { r0: 0 })).resolves.toBe(1)
		expect(runFunc(functions.snaz, ["r0", "r0", "r0"], { r0: -1 })).resolves.toBe(1)
	})
